...
function getIconPath(iconType) {
  if (iconType !== -977586066) {
    if (iconType >= 512905955) {
      if (iconType >= 944645571) {
                    ...
                    /* :: */[
                      ...
                      /* :: */[
                        ...
                        /* :: */[
                          ...
                          /* :: */[
                            Emotion.verticalAlign(/* textTop */516406248),
                            /* :: */[
...
function make(icon, $staropt$star, $staropt$star$1, _children) {
  ...
  var bsSize = $staropt$star$1 !== undefined ? $staropt$star$1 : /* medium */-20425611;
  return /* record */[
